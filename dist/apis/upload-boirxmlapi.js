...
exports.UploadBOIRXMLApi = exports.UploadBOIRXMLApiFactory = exports.UploadBOIRXMLApiFp = exports.UploadBOIRXMLApiAxiosParamCreator = void 0;
 ...
 * @export
 */
exports.UploadBOIRXMLApiAxiosParamCreator = function (configuration) {
    var _this = this;
    return {
        /**
         ...
         */
        upload: function (processId, xmlFileName, body, options) {
                    ...
                    switch (_b.label) {
                        case 0:
                            ...
                            if (processId === null || processId === undefined) {
                                throw new base_1.RequiredError('processId', 'Required parameter processId was null or undefined when calling upload.');
                            }
                            // verify required parameter 'xmlFileName' is not null or undefined
                            if (xmlFileName === null || xmlFileName === undefined) {
                                throw new base_1.RequiredError('xmlFileName', 'Required parameter xmlFileName was null or undefined when calling upload.');
                            }
                            localVarPath = "/upload/BOIR/{processId}/{xmlFileName}"
 ...
 * @export
 */
exports.UploadBOIRXMLApiFp = function (configuration) {
    return {
        /**
         * <table border=\"1\" cellspacing=\"10\" cellpadding=\"10\" width=\"100%\">   <colgroup>     <col span=\"1\" width=\"7%\"  />     <col span=\"1\" width=\"7%\" />     <col span=\"1\" width=\"43%\" />     <col span=\"1\" width=\"43%\" />   </colgroup>   <tbody>       <tr>           <td />           <td />           <td />           <td><strong>Comments</strong></td>       </tr>       <tr>           <td><strong>Endpoint</strong></td>           <td>GET</td>           <td>/upload/BOIR/{processId}/{xmlFileName}</td>           <td>Upload and submit the BOIR XML</td>       </tr>       <tr>           <td rowspan=\"2\"><strong>Path Parameters</strong></td>           <td>processId</td>           <td>processId from /processId</td>           <td/>           <td/>       </tr>       <tr>           <td>xmlFileName</td>           <td>XML file name</td>           <td>             File name for the XML file must end in .xml and must be URI encoded.              <br/><br/>             Filename limitations: Letters, numbers, _ ! @ # $ % ( ) = + [ ] { } | ; ~ -           </td>       </tr>       <tr>           <td  rowspan=\"2\" >               <strong>Request Headers</strong> <strong></strong>               <strong></strong>           </td>           <td>Content-Type</td>           <td>application/xml</td>           <td/>       </tr>       <tr>           <td>               Authorization           </td>           <td>\"Bearer &lt;access_token&gt;\"</p></td>           <td></td>       </tr>       <tr>           <td><strong>Request Body</strong></td>           <td></td>           <td>XML file binary data</td>           <td></td>       </tr>       <tr>           <td rowspan=\"2\"><strong>Response</strong></td>           <td>Content-Type</td>           <td>application/json</td>           <td></td>       </tr>       <tr>           <td>Body</td>           <td>             <div>               JSON payload for successful upload:                <dl>                 <dt>{ processId: &ltprocessId&gt, status: \"submission_initiated\" }</dt>               </dl>             </div>           </td>           <td></td>       </tr>   </tbody> </table>
         * @param {string} processId processId from /processId
        ...
        upload: function (processId, xmlFileName, body, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, exports.UploadBOIRXMLApiAxiosParamCreator(configuration).upload(processId, xmlFileName, body, options)];
                        case 1:
 ...
 * @export
 */
exports.UploadBOIRXMLApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         * <table border=\"1\" cellspacing=\"10\" cellpadding=\"10\" width=\"100%\">   <colgroup>     <col span=\"1\" width=\"7%\"  />     <col span=\"1\" width=\"7%\" />     <col span=\"1\" width=\"43%\" />     <col span=\"1\" width=\"43%\" />   </colgroup>   <tbody>       <tr>           <td />           <td />           <td />           <td><strong>Comments</strong></td>       </tr>       <tr>           <td><strong>Endpoint</strong></td>           <td>GET</td>           <td>/upload/BOIR/{processId}/{xmlFileName}</td>           <td>Upload and submit the BOIR XML</td>       </tr>       <tr>           <td rowspan=\"2\"><strong>Path Parameters</strong></td>           <td>processId</td>           <td>processId from /processId</td>           <td/>           <td/>       </tr>       <tr>           <td>xmlFileName</td>           <td>XML file name</td>           <td>             File name for the XML file must end in .xml and must be URI encoded.              <br/><br/>             Filename limitations: Letters, numbers, _ ! @ # $ % ( ) = + [ ] { } | ; ~ -           </td>       </tr>       <tr>           <td  rowspan=\"2\" >               <strong>Request Headers</strong> <strong></strong>               <strong></strong>           </td>           <td>Content-Type</td>           <td>application/xml</td>           <td/>       </tr>       <tr>           <td>               Authorization           </td>           <td>\"Bearer &lt;access_token&gt;\"</p></td>           <td></td>       </tr>       <tr>           <td><strong>Request Body</strong></td>           <td></td>           <td>XML file binary data</td>           <td></td>       </tr>       <tr>           <td rowspan=\"2\"><strong>Response</strong></td>           <td>Content-Type</td>           <td>application/json</td>           <td></td>       </tr>       <tr>           <td>Body</td>           <td>             <div>               JSON payload for successful upload:                <dl>                 <dt>{ processId: &ltprocessId&gt, status: \"submission_initiated\" }</dt>               </dl>             </div>           </td>           <td></td>       </tr>   </tbody> </table>
         * @param {string} processId processId from /processId
        ...
        upload: function (processId, xmlFileName, body, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, exports.UploadBOIRXMLApiFp(configuration).upload(processId, xmlFileName, body, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
    };
 ...
 * @extends {BaseAPI}
 */
var UploadBOIRXMLApi = /** @class */ (function (_super) {
    __extends(UploadBOIRXMLApi, _super);
    function UploadBOIRXMLApi() {
     ...
     */
    UploadBOIRXMLApi.prototype.upload = function (processId, xmlFileName, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, exports.UploadBOIRXMLApiFp(this.configuration).upload(processId, xmlFileName, body, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
    return UploadBOIRXMLApi;
}(base_1.BaseAPI));
exports.UploadBOIRXMLApi = UploadBOIRXMLApi;
